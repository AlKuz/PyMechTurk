...
if __name__ == "__main__":
    ...
    question_1 = Question(
        ...
        name="The Next Move",
        is_required=True,
        content=Content().add_text("What are the coordinates of the best move for player 'X' in this game?"),
    ...
    question_2 = Question(
        ...
        name="The Next Move",
        is_required=True,
        content=Content().add_text("How likely is it that player 'X' will win this game?"),
